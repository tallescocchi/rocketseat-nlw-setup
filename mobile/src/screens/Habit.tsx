...
export function Habit() {
  ...
  async function fetchHabits() {
    try {
      ...
      console.log(error)
      Alert.alert('Ops! Deu erro!', 'Não foi possível carregar as informações dos hábitos')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <View className="flex-1 bg-background px-8 pt-16">
      ...
      >
        ...
        {
          isDateInPast && (
            <Text className="text-zinc-200 text-lg mt-10 text-center">
              Você não pode editar um hábito antigo
            </Text>
          )
        }
      </ScrollView>
